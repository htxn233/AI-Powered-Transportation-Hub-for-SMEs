...
const capacityData = warehousesData.map((w) => ({
  ...
  remaining: Math.round(
    ((w.capacity - w.currentLoad) / w.capacity) * 100,
  ),
}));

export function WarehousesPage() {
  const [scanDialogOpen, setScanDialogOpen] = useState(false);
  const [scanType, setScanType] = useState<'inbound' | 'outbound'>(
    'inbound',
  );
  const [selectedWarehouse, setSelectedWarehouse] = useState<
    (typeof warehousesData)[number] | null
  >(null);
          ...
          <Dialog open={scanDialogOpen} onOpenChange={setScanDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Scan barcode for inbound or outbound goods
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant={
                        scanType === 'inbound' ? 'default' : 'outline'
                      }
                      className="flex-1"
                    ...
                    <Button
                      variant={
                        scanType === 'outbound' ? 'default' : 'outline'
                      }
                      className="flex-1"
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center justify-between mt-1 text-xs text-muted-foreground">
                    <span>
                      {warehouse.currentLoad.toLocaleString()} used
                    </span>
                    <span>
                      {warehouse.capacity.toLocaleString()} total
                    </span>
                  </div>
                </div>
        ...
        >
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Complete warehouse information and statistics
              </DialogDescription>
            </DialogHeader>
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-foreground">
                          {selectedWarehouse.currentLoad.toLocaleString()} units
                        </span>
                      </div>
                      <div className="flex justify-between">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                onClick={() => {
                  ...
                  // Navigate first, then close the dialog to avoid unmounting
                  // the dialog component before navigation can complete.
                  navigate(`/dashboard/warehouses/${encodeURIComponent(String(id))}/inventory`);
